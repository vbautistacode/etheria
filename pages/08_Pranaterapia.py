...
if session_path.exists() and intent == "Respiração guiada":
    ...
    <div id="prana_control_wrap_{escaped_fname}" style="display:flex;flex-direction:column;align-items:center;margin-top:12px;">
      <button id="prana_visual_play_{escaped_fname}" style="padding:12px 12px;border-radius:10px;border:none;background:#fff;cursor:pointer;font-weight:700;">
        ▶️ Iniciar / Pausar
      </button>
      <button id="prana_visual_stop_{escaped_fname}" style="padding:12px 12px;border-radius:10px;border:none;background:#fff;cursor:pointer;font-weight:700;margin-left:8px;">
        ⏹️ Parar
      </button>
